select distinct concat('"',scd_review.SCD_rxcui,'","',
		...
		maps.prop_term_name,'"') as valueString
from scd_review
...
union (select distinct '"SCD_RxCUI","Status","DF_str","SCD_str","ROUTE_rxt","NEWDF_rxt","Original Term Name","Original Term Source","Proposed Attribute ID","Proposed Attribute Category","Proposed Attribute Attribute","Proposed Term ID","Proposed Term Parent ID","Proposed Term Name"' 
		from terms)
